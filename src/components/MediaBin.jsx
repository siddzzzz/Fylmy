      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 12 }}>
        ...
        {activeTab === 'text' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            {[
              {
                title: '⚡ Viral Reel / Shorts Subtitle (Pop-In)',
                desc: 'High-retention bold yellow text with pop bounce',
              ...
              {
                title: '⌨️ Real-Time Typewriter Narration',
                desc: 'Letter-by-letter live typing effect',
                text: 'This changes everything in filmmaking...',
                fontSize: 34,
                color: '#f8fafc',
                strokeColor: '#000000',
                strokeWidth: 2,
              ...
              {
                title: '🔥 Attention-Grabbing Hook (Slide-Up)',
              ...
              {
                title: '🌟 Neon Cyberpunk Glow Title',
                desc: 'Futuristic glowing neon sign typography',
                text: 'CYBERPUNK 2088',
                fontSize: 48,
                color: '#38bdf8',
                strokeColor: '#0284c7',
